...
const SimCallABI = "[{\"inputs\":[{\"internalType\":\"address\",\"name\":\"token\",\"type\":\"address\"},{\"internalType\":\"address\",\"name\":\"spender\",\"type\":\"address\"}],\"name\":\"approve\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"tokenIn\",\"type\":\"address\"},{\"internalType\":\"address\",\"name\":\"tokenOut\",\"type\":\"address\"},{\"internalType\":\"address\",\"name\":\"router\",\"type\":\"address\"},{\"internalType\":\"bytes\",\"name\":\"data\",\"type\":\"bytes\"}],\"name\":\"testSwap\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"token1Diff\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"token2Diff\",\"type\":\"uint256\"}],\"stateMutability\":\"payable\",\"type\":\"function\"}]"
...
// TestSwap is a paid mutator transaction binding the contract method 0x21bd38fa.
//
// Solidity: function testSwap(address tokenIn, address tokenOut, address router, bytes data) payable returns(uint256 token1Diff, uint256 token2Diff)
func (_SimCall *SimCallTransactor) TestSwap(opts *bind.TransactOpts, tokenIn common.Address, tokenOut common.Address, router common.Address, data []byte) (*types.Transaction, error) {
	return _SimCall.contract.Transact(opts, "testSwap", tokenIn, tokenOut, router, data)
}

// TestSwap is a paid mutator transaction binding the contract method 0x21bd38fa.
//
// Solidity: function testSwap(address tokenIn, address tokenOut, address router, bytes data) payable returns(uint256 token1Diff, uint256 token2Diff)
func (_SimCall *SimCallSession) TestSwap(tokenIn common.Address, tokenOut common.Address, router common.Address, data []byte) (*types.Transaction, error) {
	return _SimCall.Contract.TestSwap(&_SimCall.TransactOpts, tokenIn, tokenOut, router, data)
}

// TestSwap is a paid mutator transaction binding the contract method 0x21bd38fa.
//
// Solidity: function testSwap(address tokenIn, address tokenOut, address router, bytes data) payable returns(uint256 token1Diff, uint256 token2Diff)
func (_SimCall *SimCallTransactorSession) TestSwap(tokenIn common.Address, tokenOut common.Address, router common.Address, data []byte) (*types.Transaction, error) {
	return _SimCall.Contract.TestSwap(&_SimCall.TransactOpts, tokenIn, tokenOut, router, data)
}
